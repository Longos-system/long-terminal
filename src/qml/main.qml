...
LongUI.Window {
    ...
    background.color: LongUI.Theme.darkMode ? settings.darkbackgroundColor : settings.lightbackgroundColor
...
//    background.opacity: rootWindow.compositing ? 0.95 : 1.0
    ...
    //     id: aboutDialog
    //     name: root.title
    //     description: qsTr("LongOS terminal simulator")
    //     iconSource: "image://icontheme/long-terminal"
    // }
    ...
    headerItem: Item {
        LongUI.TabBar {
            ...
            anchors.rightMargin: LongUI.Units.largeSpacing * 4
            ...
            delegate: LongUI.TabButton {
                id: _tabBtn
                text: _tabView.contentModel.get(index).title
                Layout.fillHeight: true
                height: _tabbar.height - LongUI.Units.smallSpacing / 2
