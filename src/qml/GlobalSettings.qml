...
Settings {
    ...
    property var colorschemes: ["Long-Light","Long-Dark","BlackOnLightYellow","BlackOnRandomLight","BlackOnWhite","Tango","Ubuntu","Solarized","SolarizedLight"]
    property string lightcolorScheme: "Long-Light"
